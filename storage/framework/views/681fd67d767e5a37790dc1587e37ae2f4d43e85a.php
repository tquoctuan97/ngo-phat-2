...
<tr class="newTableRow">
    <td>
        <input :value="column.name" @input="onColumnNameInput" type="text" class="form-control" required pattern="<?php echo e($db->identifierRegex, false); ?>">
    </td>
    ...
    <td>
        <select :value="index.type" @change="onIndexTypeChange"
                ...
                class="form-control">
            <option value=""></option>
            <option value="INDEX"><?php echo e(__('voyager::database.index'), false); ?></option>
            <option value="UNIQUE"><?php echo e(__('voyager::database.unique'), false); ?></option>
            <option value="PRIMARY"><?php echo e(__('voyager::database.primary'), false); ?></option>
        </select>
        <small v-if="column.composite" v-once><?php echo e(__('voyager::database.composite_warning'), false); ?></small>
    </td>
    ...
    Vue.component('database-column', {
        ...
        methods: {
            ...
            onIndexTypeChange(event) {
                if (this.column.name == '') {
                    return toastr.error("<?php echo e(__('voyager::database.name_warning'), false); ?>");
                }
...
<?php /**PATH C:\xampp\htdocs\ngophat\vendor\tcg\voyager\src/../resources/views/tools/database/vue-components/database-column.blade.php ENDPATH**/ ?>