            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name"><?php echo e(__('voyager::analytics.select_view'), false); ?></h1>
                                <div class="Titles-sub"><?php echo e(__('voyager::analytics.various_visualizations'), false); ?></div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main"><?php echo e(__('voyager::analytics.this_vs_last_week'), false); ?></h1>
                                <div class="Titles-sub"><?php echo e(__('voyager::analytics.by_users'), false); ?></div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main"><?php echo e(__('voyager::analytics.this_vs_last_year'), false); ?></h1>
                                <div class="Titles-sub"><?php echo e(__('voyager::analytics.by_users'), false); ?></div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main"><?php echo e(__('voyager::analytics.top_browsers'), false); ?></h1>
                                <div class="Titles-sub"><?php echo e(__('voyager::analytics.by_pageview'), false); ?></div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main"><?php echo e(__('voyager::analytics.top_countries'), false); ?></h1>
                                <div class="Titles-sub"><?php echo e(__('voyager::analytics.by_sessions'), false); ?></div>
                            </header>
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                gapi.analytics.auth.authorize({
                    ...
                    clientid: '<?php echo e($google_analytics_client_id, false); ?>'
                });
                ...
                var viewSelector = new gapi.analytics.ext.ViewSelector2({
                    ...
                    propertyId: '<?php echo e(Voyager::setting("site.google_analytics_tracking_id"), false); ?>'
                })
                        .execute();
                ...
                function renderWeekOverWeekChart(ids) {
                    ...
                    Promise.all([thisWeek, lastWeek]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '<?php echo e(__('voyager::date.last_week'), false); ?>',
                                ...
                                {
                                    label: '<?php echo e(__('voyager::date.this_week'), false); ?>',
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '<?php echo e(__('voyager::date.last_year'), false); ?>',
                                    fillColor: 'rgba(220,220,220,0.5)',
                                    strokeColor: 'rgba(220,220,220,1)',
                                    data: data2
                                },
                                {
                                    label: '<?php echo e(__('voyager::date.this_year'), false); ?>',
                                    fillColor: 'rgba(151,187,205,0.5)',
                                    strokeColor: 'rgba(151,187,205,1)',
                                    data: data1
                                }
