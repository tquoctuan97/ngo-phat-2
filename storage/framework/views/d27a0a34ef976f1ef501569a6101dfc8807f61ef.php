        ...
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                <?php if(count($segments) == 0): ?>
                    <li class="active"><i class="voyager-boat"></i> <?php echo e(__('voyager::generic.dashboard'), false); ?></li>
                <?php else: ?>
                    <li class="active">
                    ...
                    <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <?php if($loop->last): ?>
                            <li><?php echo e(ucfirst($segment), false); ?></li>
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e($url, false); ?>"><?php echo e(ucfirst($segment), false); ?></a>
                            </li>
                        <?php endif; ?>
        ...
        <ul class="nav navbar-nav <?php if(config('voyager.multilingual.rtl')): ?> navbar-left <?php else: ?> navbar-right <?php endif; ?>">
            <li class="dropdown profile">
                <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button"
                   aria-expanded="false"><img src="<?php echo e($user_avatar, false); ?>" class="profile-img"> <span
                            class="caret"></span></a>
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li class="profile-img">
                        <img src="<?php echo e($user_avatar, false); ?>" class="profile-img">
                        <div class="profile-body">
                            <h5><?php echo e(app('VoyagerAuth')->user()->name, false); ?></h5>
                            <h6><?php echo e(app('VoyagerAuth')->user()->email, false); ?></h6>
                        </div>
                    </li>
                    <li class="divider"></li>
                    ...
                    <li <?php echo isset($item['classes']) && !empty($item['classes']) ? 'class="'.$item['classes'].'"' : ''; ?>>
                        ...
                        <form action="<?php echo e(route('voyager.logout'), false); ?>" method="POST">
                            ...
                            <button type="submit" class="btn btn-danger btn-block">
                                ...
                                <?php endif; ?>
                                <?php echo e(__($name), false); ?>

                            </button>
                        </form>
                        <?php else: ?>
                        <a href="<?php echo e(isset($item['route']) && Route::has($item['route']) ? route($item['route']) : (isset($item['route']) ? $item['route'] : '#'), false); ?>" <?php echo isset($item['target_blank']) && $item['target_blank'] ? 'target="_blank"' : ''; ?>>
                            <?php if(isset($item['icon_class']) && !empty($item['icon_class'])): ?>
                            <i class="<?php echo $item['icon_class']; ?>"></i>
                            <?php endif; ?>
                            <?php echo e(__($name), false); ?>
...
<?php /**PATH C:\xampp\htdocs\ngophat-phase-1\ngo-phat-2\vendor\tcg\voyager\src/../resources/views/dashboard/navbar.blade.php ENDPATH**/ ?>