...
<div>
                ...
                <div class="file_link selected" aria-hidden="true" data-toggle="tooltip" data-placement="auto" :title="file">
                    <div class="link_icon">
                        <template v-if="fileIs(file, 'image')">
                            <div class="img_icon" :style="imgIcon('<?php echo e(Storage::disk(config('voyager.storage.disk'))->url('/'), false); ?>'+file)"></div>
                        </template>
    ...
    <div v-if="hidden_element">
        <div class="btn btn-sm btn-default" v-on:click="expanded = !expanded;" style="width:100%">
            <div v-if="!expanded"><i class="voyager-double-down"></i> <?php echo e(__('voyager::generic.open'), false); ?></div>
            <div v-if="expanded"><i class="voyager-double-up"></i> <?php echo e(__('voyager::generic.close'), false); ?></div>
        </div>
    </div>
    <div id="toolbar" v-if="showToolbar" :style="expanded ? 'display:block' : 'display:none'">
        <div class="btn-group offset-right">
            <button type="button" class="btn btn-primary" id="upload" v-if="allowUpload">
                ...
                <?php echo e(__('voyager::generic.upload'), false); ?>
            ...
            <button type="button" class="btn btn-primary" v-if="allowCreateFolder" data-toggle="modal" :data-target="'#create_dir_modal_'+this._uid">
                ...
                <?php echo e(__('voyager::generic.add_folder'), false); ?>
        ...
        <div class="btn-group offset-right">
            <button type="button" v-if="showFolders && allowMove" class="btn btn-default" data-toggle="modal" :data-target="'#move_files_modal_'+this._uid">
                ...
                <?php echo e(__('voyager::generic.move'), false); ?>
            ...
            <button type="button" v-if="allowDelete" :disabled="selected_files.length == 0" class="btn btn-default" data-toggle="modal" :data-target="'#confirm_delete_modal_'+this._uid">
                ...
                <?php echo e(__('voyager::generic.delete'), false); ?>
            ...
            <button v-if="allowCrop" :disabled="selected_files.length != 1 || !fileIs(selected_file, 'image')" type="button" class="btn btn-default" data-toggle="modal" :data-target="'#crop_modal_'+this._uid">
                ...
                <?php echo e(__('voyager::media.crop'), false); ?>
        ...
        <div class="breadcrumb-container">
            <ol class="breadcrumb filemanager">
                <li class="media_breadcrumb" v-on:click="setCurrentPath(-1)">
                    ...
                    <strong><?php echo e(__('voyager::media.library'), false); ?></strong>
                </li>
        ...
        <div class="flex">
            <div id="left">
                ...
                <div id="file_loader" v-if="is_loading">
                    ...
                    <img src="<?php echo e(voyager_asset('images/logo-icon.png'), false); ?>" alt="Voyager Loader">
                    <?php else: ?>
                    <img src="<?php echo e(Voyager::image($admin_loader_img), false); ?>" alt="Voyager Loader">
                    <?php endif; ?>
                    <p><?php echo e(__('voyager::media.loading'), false); ?></p>
                </div>

                <div id="no_files" v-if="files.length == 0">
                    <h3><i class="voyager-meh"></i> <?php echo e(__('voyager::media.no_files_in_folder'), false); ?></h3>
                </div>
            </div>
            <div id="right">
                <div class="right_details">
                    <div v-if="selected_files.length > 1" class="right_none_selected">
                        ...
                        <p>{{ selected_files.length }} <?php echo e(__('voyager::media.files_selected'), false); ?></p>
                    </div>
                    <div v-else-if="selected_files.length == 1" class="right_details">
                        <div class="detail_img">
                            ...
                            <div v-else-if="fileIs(selected_file, 'video')">
                                <video width="100%" height="auto" ref="videoplayer" controls>
                                    ...
                                    <?php echo e(__('voyager::media.browser_video_support'), false); ?>
                            ...
                            <div v-else-if="fileIs(selected_file, 'audio')">
                                ...
                                <audio controls style="width:100%; margin-top:5px;" ref="audioplayer">
                                    ...
                                    <?php echo e(__('voyager::media.browser_audio_support'), false); ?>
                        ...
                        <div class="detail_info">
                            <span>
                                <h4><?php echo e(__('voyager::media.title'), false); ?>:</h4>
                            ...
                            <span>
                                <h4><?php echo e(__('voyager::media.type'), false); ?>:</h4>
                                <p>{{ selected_file.type }}</p>
                            </span>

                            <template v-if="!fileIs(selected_file, 'folder')">
                                <span>
                                    <h4><?php echo e(__('voyager::media.size'), false); ?>:</h4>
                                    <p><span class="selected_file_size">{{ bytesToSize(selected_file.size) }}</span></p>
                                </span>
                                <span>
                                    <h4><?php echo e(__('voyager::media.public_url'), false); ?>:</h4>
                                    <p><a :href="selected_file.path" target="_blank"><?php echo e(__('voyager::generic.click_here'), false); ?></a></p>
                                </span>
                                <span>
                                    <h4><?php echo e(__('voyager::media.last_modified'), false); ?>:</h4>
                    ...
                    <div v-else class="right_none_selected">
                        ...
                        <p><?php echo e(__('voyager::media.nothing_selected'), false); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade modal-info" :id="'create_dir_modal_'+this._uid">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><i class="voyager-folder"></i> <?php echo e(__('voyager::media.add_new_folder'), false); ?></h4>
                </div>

                <div class="modal-body">
                    <input name="new_folder_name" placeholder="<?php echo e(__('voyager::media.new_folder_name'), false); ?>" class="form-control" value="" v-model="modals.new_folder.name" />
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel'), false); ?></button>
                    <button type="button" class="btn btn-info" v-on:click="createFolder"><?php echo e(__('voyager::media.create_new_folder'), false); ?>
    ...
    <div class="modal fade modal-danger" :id="'confirm_delete_modal_'+this._uid" v-if="allowDelete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4><?php echo e(__('voyager::media.delete_question'), false); ?></h4>
                    <ul>
                        <li v-for="file in selected_files">{{ file.name }}</li>
                    </ul>
                    <h5 class="folder_warning">
                        <i class="voyager-warning"></i> <?php echo e(__('voyager::media.delete_folder_question'), false); ?>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel'), false); ?></button>
                    <button type="button" class="btn btn-danger" v-on:click="deleteFiles"><?php echo e(__('voyager::generic.delete_confirm'), false); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-move"></i> <?php echo e(__('voyager::media.move_file_folder'), false); ?></h4>
                </div>

                <div class="modal-body">
                    <h4><?php echo e(__('voyager::media.destination_folder'), false); ?></h4>
                    <select class="form-control" v-model="modals.move_files.destination">
                        <option value="" disabled><?php echo e(__('voyager::media.destination_folder'), false); ?></option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel'), false); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="moveFiles"><?php echo e(__('voyager::generic.move'), false); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade modal-warning" :id="'crop_modal_'+this._uid" v-if="allowCrop">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><i class="voyager-warning"></i> <?php echo e(__('voyager::media.crop_image'), false); ?></h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="new-image-info">
                        <?php echo e(__('voyager::media.width'), false); ?> <span :id="'new-image-width_'+this._uid"></span>, <?php echo e(__('voyager::media.height'), false); ?><span :id="'new-image-height_'+this._uid"></span>
                    </div>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel'), false); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="crop(false)"><?php echo e(__('voyager::media.crop'), false); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="crop(true)"><?php echo e(__('voyager::media.crop_and_create'), false); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    Vue.component('media-manager', {
        ...
        methods: {
            getFiles: function() {
                var vm = this;
                vm.is_loading = true;
                $.post('<?php echo e(route('voyager.media.files'), false); ?>', { folder: vm.current_folder, _token: '<?php echo e(csrf_token(), false); ?>', details: vm.details }, function(data) {
                    vm.files = [];
                ...
                if (file.type != 'folder') {
                    if (!this.allowMultiSelect) {
                        ...
                        if (content.length >= this.maxSelectedFiles && this.maxSelectedFiles > 0) {
                            var msg_sing = "<?php echo e(trans_choice('voyager::media.max_files_select', 1), false); ?>";
                            var msg_plur = "<?php echo e(trans_choice('voyager::media.max_files_select', 2), false); ?>";
            ...
            renameFile: function(object) {
                ...
                $.post('<?php echo e(route('voyager.media.rename'), false); ?>', {
					...
					if (data.success == true) {
						toastr.success('<?php echo e(__('voyager::media.success_renamed'), false); ?>', "<?php echo e(__('voyager::generic.sweet_success'), false); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie'), false); ?>");
					}
				});
            },
            createFolder: function(e) {
                ...
                $.post('<?php echo e(route('voyager.media.new_folder'), false); ?>', { new_folder: vm.current_folder+'/'+name, _token: '<?php echo e(csrf_token(), false); ?>' }, function(data) {
					if(data.success == true){
						toastr.success('<?php echo e(__('voyager::generic.successfully_created'), false); ?> ' + name, "<?php echo e(__('voyager::generic.sweet_success'), false); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie'), false); ?>");
					}
            ...
            deleteFiles: function() {
                ...
                var vm = this;
                $.post('<?php echo e(route('voyager.media.delete'), false); ?>', {
                    path: vm.current_folder,
                    files: vm.selected_files,
                    _token: '<?php echo e(csrf_token(), false); ?>'
                }, function(data){
					if(data.success == true){
						toastr.success('', "<?php echo e(__('voyager::generic.sweet_success'), false); ?>");
						vm.getFiles();
            ...
            moveFiles: function(e) {
				...
				$.post('<?php echo e(route('voyager.media.move'), false); ?>', {
                    path: vm.current_folder,
                    files: vm.selected_files,
					...
					if(data.success == true){
						toastr.success('<?php echo e(__('voyager::media.success_moved'), false); ?>', "<?php echo e(__('voyager::generic.sweet_success'), false); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie'), false); ?>");
					}
            ...
            crop: function(mode) {
                ...
                if (!mode) {
                    if (!window.confirm('<?php echo e(__('voyager::media.crop_override_confirm'), false); ?>')) {
						return;
					}
                }
                ...
                var vm = this;
                var postData = Object.assign(croppedData, { _token: '<?php echo e(csrf_token(), false); ?>' });
				$.post('<?php echo e(route('voyager.media.crop'), false); ?>', postData, function(data) {
					if (data.success) {
        ...
        mounted: function() {
            ...
            if (this.allowUpload && !dropzone.hasClass('dz-clickable')) {
                dropzone.dropzone({
                    timeout: 180000,
                    url: '<?php echo e(route('voyager.media.upload'), false); ?>',
                    ...
                    sending: function(file, xhr, formData) {
                        formData.append("_token", '<?php echo e(csrf_token(), false); ?>');
                    ...
                    success: function(e, res) {
                        if (res.success) {
                            toastr.success(res.message, "<?php echo e(__('voyager::generic.sweet_success'), false); ?>");
                        } else {
                            toastr.error(res.message, "<?php echo e(__('voyager::generic.whoopsie'), false); ?>");
                        }
                    },
                    error: function(e, res, xhr) {
                        toastr.error(res, "<?php echo e(__('voyager::generic.whoopsie'), false); ?>");
                    },
                    ...
                    if (vm.hidden_element) {
                        if (vm.maxSelectedFiles > 1) {
                            ...
                            if (content.length < vm.minSelectedFiles) {
                                e.preventDefault();
                                var msg_sing = "<?php echo e(trans_choice('voyager::media.min_files_select', 1), false); ?>";
                                var msg_plur = "<?php echo e(trans_choice('voyager::media.min_files_select', 2), false); ?>";
                            ...
                            if (vm.minSelectedFiles > 0 && vm.hidden_element.value == '') {
                                e.preventDefault();
                                toastr.error("<?php echo e(trans_choice('voyager::media.min_files_select', 1), false); ?>");
                            }
                        }
                    }
                });
...
<?php /**PATH C:\xampp\htdocs\ngophat-phase-1\ngo-phat-2\vendor\tcg\voyager\src/../resources/views/media/manager.blade.php ENDPATH**/ ?>