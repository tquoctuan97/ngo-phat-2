...
<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        ...
        <?php echo e(__('voyager::generic.'.($edit ? 'edit' : 'add')).' '.$dataType->display_name_singular, false); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            class="form-edit-add"
                            action="<?php echo e($edit ? route('voyager.'.$dataType->slug.'.update', $dataTypeContent->getKey()) : route('voyager.'.$dataType->slug.'.store'), false); ?>"
                        ...
                        <div class="panel-body">
                            ...
                            <?php $__currentLoopData = $dataTypeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(isset($row->details->legend) && isset($row->details->legend->text)): ?>
                                    <legend class="text-<?php echo e($row->details->legend->align ?? 'center', false); ?>" style="background-color: <?php echo e($row->details->legend->bgcolor ?? '#f0f0f0', false); ?>;padding: 5px;"><?php echo e($row->details->legend->text, false); ?></legend>
                                <?php endif; ?>

                                <div class="form-group <?php if($row->type == 'hidden'): ?> hidden <?php endif; ?> col-md-<?php echo e($display_options->width ?? 12, false); ?> <?php echo e($errors->has($row->field) ? 'has-error' : '', false); ?>" <?php if(isset($display_options->id)): ?><?php echo e("id=$display_options->id", false); ?><?php endif; ?>>
                                    <?php echo e($row->slugify, false); ?>

                                    <label class="control-label" for="name"><?php echo e($row->display_name, false); ?></label>
                                    ...
                                    <?php if($errors->has($row->field)): ?>
                                        <?php $__currentLoopData = $errors->get($row->field); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="help-block"><?php echo e($error, false); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="panel-footer">
                            <?php $__env->startSection('submit-buttons'); ?>
                                <button type="submit" class="btn btn-primary save"><?php echo e(__('voyager::generic.save'), false); ?></button>
                            <?php $__env->stopSection(); ?>
                    ...
                    <form id="my_form" action="<?php echo e(route('voyager.upload'), false); ?>" target="form_target" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="confirm_delete"><?php echo e(__('voyager::generic.delete_confirm'), false); ?></button>
                </div>
            </div>
        </div>
    </div>
