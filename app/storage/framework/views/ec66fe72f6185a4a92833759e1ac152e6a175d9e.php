...
<div class="panel panel-bordered">
    <div class="panel-body">
        ...
        <?php else: ?>
            <div class="col-md-6">
        <?php endif; ?>
                <label for="name"><?php echo e(__('voyager::database.table_name'), false); ?></label><br>
                <input v-model.trim="table.name" type="text" class="form-control" placeholder="<?php echo e(__('voyager::database.table_name'), false); ?>" required pattern="<?php echo e($db->identifierRegex, false); ?>">
            </div>

        <?php if($db->action == 'create'): ?>
            <div class="col-md-3 col-sm-4 col-xs-6">
                <label for="create_model"><?php echo e(__('voyager::database.create_model_table'), false); ?></label><br>
                <input type="checkbox" name="create_model" data-toggle="toggle"
                       data-on="<?php echo e(__('voyager::generic.yes_please'), false); ?>" data-off="<?php echo e(__('voyager::generic.no_thanks'), false); ?>">
            </div>
        ...
        <div v-if="compositeIndexes.length" v-once class="alert alert-danger">
            <p><?php echo e(__('voyager::database.no_composites_warning'), false); ?></p>
        </div>

        <div id="alertsContainer"></div>

        <template v-if="tableHasColumns">
            <p><?php echo e(__('voyager::database.table_columns'), false); ?></p>

            <table class="table table-bordered" style="width:100%;">
                <thead>
                <tr>
                    <th><?php echo e(__('voyager::generic.name'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.type'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.length'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.not_null'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.unsigned'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.auto_increment'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.index'), false); ?></th>
                    <th><?php echo e(__('voyager::generic.default'), false); ?></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <div v-else>
          <p><?php echo e(__('voyager::database.table_no_columns'), false); ?></p>
        </div>
    ...
    <div class="panel-footer">
        <input type="submit" class="btn btn-primary pull-right"
               value="<?php if($db->action == 'update'): ?><?php echo e(__('voyager::database.update_table'), false); ?><?php else: ?><?php echo e(__('voyager::database.create_new_table'), false); ?><?php endif; ?>"
        ...
        methods: {
            addColumn(column) {
                ...
                if (column.name && this.hasColumn(column.name)) {
                    return toastr.error("<?php echo e(__('voyager::database.column'), false); ?> " + column.name + " <?php echo e(__('voyager::database.already_exists'), false); ?>");
                }
            ...
            renameColumn(column) {
                ...
                if ((existingColumn = this.getColumn(newName)) && (existingColumn !== column)) {
                    return toastr.error("<?php echo e(__('voyager::database.column'), false); ?> " + newName + " <?php echo e(__('voyager::database.already_exists'), false); ?>");
                }
            ...
            addIndex(index) {
                if (index.type == 'PRIMARY') {
                    if (this.table.primaryKeyName) {
                        return toastr.error("<?php echo e(__('voyager::database.table_has_index'), false); ?>");
                    }
...
<?php /**PATH C:\xampp\htdocs\ngophat\vendor\tcg\voyager\src/../resources/views/tools/database/vue-components/database-table-editor.blade.php ENDPATH**/ ?>