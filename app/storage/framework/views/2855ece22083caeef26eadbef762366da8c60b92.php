...
<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        ...
        <?php if($db->action == 'update'): ?>
            <?php echo e(__('voyager::database.editing_table', ['table' => $db->table->name]), false); ?>

        <?php else: ?>
            <?php echo e(__('voyager::database.create_new_table'), false); ?>
...
<ol class="breadcrumb hidden-xs">
    ...
    <li>
        <a href="<?php echo e(route('voyager.database.index'), false); ?>">
            <?php echo e(__('voyager::generic.database'), false); ?>

        </a>
    </li>

    <?php if($db->action == 'update'): ?>
    <li class="active"><?php echo e(__('voyager::generic.edit'), false); ?></li>
    <li class="active"><?php echo e($db->table->name, false); ?></li>
    <?php else: ?>
    <li class="active"><?php echo e(__('voyager::generic.add'), false); ?></li>
    <?php endif; ?>
</ol>
<?php $__env->stopSection(); ?>
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div id="dbManager" class="col-md-12">
                <form ref="form" @submit.prevent="stringifyTable" @keydown.enter.prevent action="<?php echo e($db->formAction, false); ?>" method="POST">
                    <?php if($db->action == 'update'): ?><?php echo e(method_field('PUT'), false); ?><?php endif; ?>
