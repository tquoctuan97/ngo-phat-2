...
<div>
    ...
    <div v-if="column.type.notSupported">
        <small><?php echo e(__('voyager::database.type_not_supported'), false); ?></small>
    </div>
</div>
...
<script>
    ...
    function getDbType(name) {
        ...
        toastr.error("<?php echo e(__('voyager::database.unknown_type'), false); ?>: " + name);
...
<?php /**PATH C:\xampp\htdocs\ngophat\vendor\tcg\voyager\src/../resources/views/tools/database/vue-components/database-types.blade.php ENDPATH**/ ?>