...
<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        <i class="voyager-list-add"></i> <?php echo e($dataType->display_name_plural, false); ?>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add',app($dataType->model_name))): ?>
            <a href="<?php echo e(route('voyager.'.$dataType->slug.'.create'), false); ?>" class="btn btn-success">
                <i class="voyager-plus"></i> <?php echo e(__('voyager::generic.add_new'), false); ?>
                    ...
                    <div class="panel-body">
                        <table id="dataTable" class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo e($row->display_name, false); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($row->type == 'image'): ?>
                                            <img src="<?php if( strpos($data->{$row->field}, 'http://') === false && strpos($data->{$row->field}, 'https://') === false): ?><?php echo e(Voyager::image( $data->{$row->field} ), false); ?><?php else: ?><?php echo e($data->{$row->field}, false); ?><?php endif; ?>" style="width:100px">
                                        <?php else: ?>
                                    ...
                                    <td class="no-sort no-click bread-actions">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $data)): ?>
                                            <div class="btn btn-sm btn-danger pull-right delete" data-id="<?php echo e($data->{$data->getKeyName()}, false); ?>">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit', $data)): ?>
                                            <a href="<?php echo e(route('voyager.'.$dataType->slug.'.edit', $data->{$data->getKeyName()}), false); ?>" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <?php echo e(__('voyager::generic.edit'), false); ?>

                                            </a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit', $data)): ?>
                                            <a href="<?php echo e(route('voyager.'.$dataType->slug.'.builder', $data->{$data->getKeyName()}), false); ?>" class="btn btn-sm btn-success pull-right">
                                                <i class="voyager-list"></i> <?php echo e(__('voyager::generic.builder'), false); ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="voyager-trash"></i> <?php echo e(__('voyager::generic.delete_question'), false); ?> <?php echo e($dataType->display_name_singular, false); ?>?
                    </h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        ...
                        <input type="submit" class="btn btn-danger pull-right delete-confirm" value="<?php echo e(__('voyager::generic.delete_this_confirm'), false); ?> <?php echo e($dataType->display_name_singular, false); ?>">
                    </form>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script>
        ...
        $('td').on('click', '.delete', function (e) {
            $('#delete_form')[0].action = '<?php echo e(route('voyager.'.$dataType->slug.'.destroy', ['menu' => '__menu']), false); ?>'.replace('__menu', $(this).data('id'));
